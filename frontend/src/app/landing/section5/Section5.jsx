...
const Section5 = () => {
  ...
  useEffect(() => {
    ...
    const parent = widgetEl.parentElement || document.body;
    ...
    // If the script is already present, try to initialize Elfsight (no-op if not available)
    ...
    <section className="relative overflow-hidden bg-[#d7e6d4] py-16 sm:py-20 lg:py-28">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-10">
        ...
        <div className="relative rounded-3xl bg-white/90 p-6 shadow-[0_22px_48px_rgba(15,53,30,0.18)]">
          ...
          <div
            ref={widgetRef}
            className="elfsight-app-5412be18-2c07-4453-9dc1-245649e63be0"
